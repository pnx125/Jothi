<%@ Page language="c#" CodeFile="frmActivity.aspx.cs" AutoEventWireup="True" Inherits="KPI.PhoenixWeb.Inmate.frmActivity" %>
				...
				<table id="Table1" style="TABLE-LAYOUT: fixed" cellSpacing="0" cellPadding="0">
					...
					<TBODY>
						...
						<tr height="6%">
							<td></td>
							<td align="center">
								<kpicc:kpilabel id="lblActivity" runat="server" KPISecurity="ACI">Activity</kpicc:kpilabel></td>
							<td></td>
						</tr>
						<TR>
							<TD></TD>
									...
									<Bands>
										<igtbl:UltraGridBand AllowUpdate="Yes" AllowAdd="Yes" GridLines="Horizontal">
											<Columns>
												...
												<igtbl:UltraGridColumn Key="Date" Width="20%" AllowUpdate="No" Format="MM/dd/yy HH:mm" BaseColumnName="Date" ><Footer Key="Date">
														<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="Date" Caption="Date/Time">
														<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="CADNo" Width="10%" AllowUpdate="No" Hidden="True" BaseColumnName="CADNo" ><Footer Key="CADNo">
														<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="CADNo" Caption="Call#">
														<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="Num" Width="10%" AllowUpdate="No" BaseColumnName="Num" ><Footer Key="Num">
														<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="Num" Caption="Activity #">
														<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="CFSCode" Width="10%" AllowUpdate="No" Hidden="True" BaseColumnName="CFSCode" ><Footer Key="CFSCode">
														<RowLayoutColumnInfo OriginX="4"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="CFSCode" Caption="CFS">
														<RowLayoutColumnInfo OriginX="4"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="ShortDesc" Width="25%" AllowUpdate="No" BaseColumnName="ShortDesc" ><Footer Key="ShortDesc">
														<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="ShortDesc" Caption="Activity Type">
														<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="Location" Width="20%" AllowUpdate="No" Hidden="True" BaseColumnName="Location" ><Footer Key="Location">
												...
												<igtbl:UltraGridColumn Key="IsExpunge" Hidden="True" BaseColumnName="IsExpunge" ><Footer Key="IsExpunge">
														<RowLayoutColumnInfo OriginX="9"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="IsExpunge">
														<RowLayoutColumnInfo OriginX="9"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="AssocType" Hidden="True" BaseColumnName="AssocType" ><Footer Key="AssocType">
														<RowLayoutColumnInfo OriginX="10"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="AssocType">
														<RowLayoutColumnInfo OriginX="10"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="ItemNo" Hidden="True" BaseColumnName="ItemNo" ><Footer Key="ItemNo">
														<RowLayoutColumnInfo OriginX="11"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="ItemNo" Caption="ItemNo">
														<RowLayoutColumnInfo OriginX="11"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="Classification" Width="20%" BaseColumnName="Classification" ><Footer Key="Classification">
														<RowLayoutColumnInfo OriginX="12"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="Classification" Caption="Classification">
														<RowLayoutColumnInfo OriginX="12"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
												<igtbl:UltraGridColumn Key="Release" Width="25%" BaseColumnName="ReleaseDttm" ><Footer Key="Release">
														<RowLayoutColumnInfo OriginX="13"></RowLayoutColumnInfo>
													</Footer>
													<Header Key="Release" Caption="Release D/T">
														<RowLayoutColumnInfo OriginX="13"></RowLayoutColumnInfo>
													</Header>
												</igtbl:UltraGridColumn>
											</Columns>
						...
						<tr>
							<td></td>
							<td><input id="hdnScreenId" style="WIDTH: 48px; HEIGHT: 22px" type="hidden" value="8513" name="hdnScreenId" runat="server" /><input id="hdnMode" style="WIDTH: 48px; HEIGHT: 22px" type="hidden" value="INQ" name="hdnMode" runat="server" /><input id="hdnNameId" style="WIDTH: 48px; HEIGHT: 22px" type="hidden" name="hdnNameId" runat="server" /><input id="hdnCaller" style="WIDTH: 48px; HEIGHT: 22px" type="hidden" name="hdnCaller" runat="server" /><input id="hdnJurisID" style="WIDTH: 48px; HEIGHT: 22px" type="hidden" name="hdnJurisID" runat="server" /></td>
							<td></td>
						</tr>
					</TBODY>
				</table>
